...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture pix = new Picture("H:\\APCSA\\wang_ryan_apcsa-p22\\Unit16\\src\\images\\blue-mark.jpg");
    pix.explore();
    
    Picture pix2 = new Picture("H:\\APCSA\\wang_ryan_apcsa-p22\\Unit16\\src\\images\\TOOTHY.jpg");
    pix2.explore();
  }
